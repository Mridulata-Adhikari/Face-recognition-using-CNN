...
def detect_faces(image, detection_api_url="http://127.0.0.1:3000/"):
    ...
    try:
        ...
        Exception(
            "You need to run detection app as described in https://github.com/fcakyon/face-recognition-app-tutorial#app-usage")
        ...
        if len(detections) > 0:
            for detection in detections:
                ...
                if confidence > min_confidence:
                    ...
                    face_path = raw_image_dir + os.sep + ".." + os.sep + 'faces' + os.sep + "face" + '_' + str(
                        index) + ".jpg"
