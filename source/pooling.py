...
class Pooling:
    ...
    def pool(self,input,pool_h,pool_w,last_maxpositions,mode='max'):
        ...
        pooled_features = np.zeros((n_input, n_featuremaps, res_height, res_width))
                ...
                for pool_row in range(res_height):
                    ...
                    for pool_col in range(res_width):
                        ...
                        if mode == 'max':
                            ...
                            pooled_features[input_num,feature_num,pool_row,pool_col] = np.max(patch)
    ...
    def pool_backprop(self,output_grad,output_shape,last_maxpositions):
        ...
        input_grad = np.zeros(output_shape)
