...
# extract faces
raw_image_dir = "images" + os.sep + "dataset" + os.sep + "train" + os.sep + "raw"
extract_faces(raw_image_dir)

# extract embeddings
classes_dir = "images" + os.sep + "dataset" + os.sep + "train" + os.sep + "10_classes"
embeddings_path = "images" + os.sep + "dataset" + os.sep + "train" + os.sep + "embeddings.pickle"
...
# recognize face
file_path = "images" + os.sep + "dataset" + os.sep + "test" + os.sep + "raw" + os.sep +"legolas6.jpg"
